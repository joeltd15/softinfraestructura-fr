...
const Responsible = () => {
  ...
  const getResponsibles = async () => {
    try {
      const response = await axios.get("https://softinfraestructura-gray.vercel.app/api/responsible", {headers})
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      await axios.delete(`https://softinfraestructura-gray.vercel.app/api/responsible/${selectedId}`, {headers})
