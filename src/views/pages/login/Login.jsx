...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const userRolePermissions = permissionsResponse.data.filter((permission) => permission.roleId === user.roleId)
      ...
      // Keep loading state true during the redirect timeout
      setTimeout(() => {
          ...
          <CCardBody>
            <CForm onSubmit={handleLogin} className="p-4">
              ...
              <div className="text-center d-block mb-2">
                <CButton type="submit" className="btn-green px-4" disabled={isLoading}>
                  {isLoading ? (
                    <>
              ...
              <div className="d-flex mt-4">
                <div className="row w-100">
                  <div className="col-sm-8">
                    <CButton color="link" className="px-0" onClick={() => navigate("/sendEmail")} disabled={isLoading}>
                      Recuperar Contraseña
                    </CButton>
                  </div>
                  <div className="col-sm-4">
                    <CButton color="link" className="px-0" onClick={() => navigate("/register")} disabled={isLoading}>
                      Registrarme!
                    </CButton>
                  </div>
                </div>
